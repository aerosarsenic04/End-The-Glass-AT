...
define config.name = _("End The Glass AT")
...
define build.name = "EndTheGlassAT"
...
default preferences.text_cps = 33.3
...
define config.save_directory = "EndTheGlassAT-1788759515"
